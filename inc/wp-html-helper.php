...
// image default alt
if ( ! function_exists( 'anipat_img_default_alt' ) ) {
	function anipat_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'anipat_img_tag' ) ) {
	function anipat_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = anipat_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'anipat_anchor_tag' ) ) {
	function anipat_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'anipat_heading_tag' ) ) {
	function anipat_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'anipat_paragraph_tag' ) ) {
	function anipat_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'anipat_other_tag' ) ) {
	function anipat_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'anipat_button_element ' ) ) {
	function anipat_button_element( array $args ) {
