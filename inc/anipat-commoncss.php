...
// enqueue css
function anipat_common_custom_css(){
    
    wp_enqueue_style( 'anipat-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= anipat_opt( 'anipat_theme_color' ) != '#131313' ? anipat_opt( 'anipat_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= anipat_opt( 'anipat_book_btn_color' ) != '#131313' ? anipat_opt('anipat_book_btn_color') : '';
		$bookBtnHoverBgColor     	= anipat_opt( 'anipat_book_btn_hvr_bg_color' ) != '#131313' ? anipat_opt('anipat_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = anipat_opt( 'anipat_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = anipat_opt( 'anipat_navbar_bg_color' ) != '#082b49' ? anipat_opt( 'anipat_navbar_bg_color') : '';
		$headerTop_col     		  = anipat_opt( 'anipat_top_header_color' );

		$headerTopBg      		  = anipat_opt( 'anipat_top_header_bg_color');
		$headerBg          		  = anipat_opt( 'anipat_header_bg_color') != '#ffffff' ? anipat_opt( 'anipat_header_bg_color') : '';
		$menuColor          	  = anipat_opt( 'anipat_header_menu_color' ) != '#131313' ? anipat_opt('anipat_header_menu_color') : '';
		$menuHoverColor           = anipat_opt( 'anipat_header_menu_hover_color' ) != '#808080' ? anipat_opt('anipat_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = anipat_opt( 'anipat_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = anipat_opt( 'anipat_header_drop_menu_bg_color' ) != '#ffffff' ? anipat_opt('anipat_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = anipat_opt( 'anipat_dropdown_menu_color' ) != '#131313' ? anipat_opt('anipat_dropdown_menu_color') : '';
		$dropMenuHovColor         = anipat_opt( 'anipat_dropdown_menu_hover_color' ) != '#808080' ? anipat_opt('anipat_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = anipat_opt( 'anipat_footer_widget_bg_color' );
		$footerwHeadColor   	  = anipat_opt('anipat_footer_widget_heading_color');
		$footerwTextColor   	  = anipat_opt('anipat_footer_widget_text_color') != '#7a7a7a' ? anipat_opt('anipat_footer_widget_text_color') : '';
		$footerwanchorcolor 	  = anipat_opt('anipat_footer_widget_anchor_color') != '#7a7a7a' ? anipat_opt('anipat_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = anipat_opt('anipat_footer_widget_anchor_hover_color') != '#eb592d' ? anipat_opt('anipat_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = anipat_opt('anipat_fof_bg_color');
		$foftonecolor			  = anipat_opt('anipat_fof_textone_color');
		$fofttwocolor			  = anipat_opt('anipat_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = anipat_opt('anipat_footer_widget_anchor_color') != '#7a7a7a' ? anipat_opt('anipat_footer_widget_anchor_color') : '#eb592d';
		...
		$customcss ="			
			...
			.header-area .main-header-area .main-menu ul li a, .header-area .main-header-area.sticky .main-menu ul li a, .header-area .social_wrap .login_text a, .header-area .social_wrap .number p a {
				color: {$menuColor};
			}
			...
			.main_menu .main-menu-item ul li .nav-link:not(.dropdown-item):hover, .header-area .main-header-area .main-menu ul li  a.dropdown-item:hover, .main_menu:not(.menu_fixed) ul.navbar-nav > li > a:hover, .header-area .social_wrap .login_text a:hover, .header-area .social_wrap .number p a:hover
			{
			...
			.main_menu ul li a:hover:before, .main_menu ul.navbar-nav li a::before, .header-area .main-header-area.sticky .main-menu ul li a::before {
				color: {$menuHoverColor}	
			}
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .anipat_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .anipat_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'anipat-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'anipat_common_custom_css', 50 );